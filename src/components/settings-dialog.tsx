...
import { loadConfig, updateConfig, Config } from '@/lib/config';
          ...
          <TabsContent value="display" className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Slider 
                ...
                max={100} 
                step={1} 
                onValueChange={(vals) => handleConfigChange({ display: { brightness: vals[0] } })}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Button 
                  variant={config.display.theme === 'light' ? "default" : "outline"}
                  className="flex-1"
                ...
                <Button 
                  variant={config.display.theme === 'dark' ? "default" : "outline"}
                  className="flex-1"
                ...
                <Button 
                  variant={config.display.theme === 'auto' ? "default" : "outline"}
                  className="flex-1"
          ...
          <TabsContent value="system" className="space-y-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <Switch 
                ...
                onCheckedChange={(checked) => handleConfigChange({ canBus: { autoConnect: checked } })}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch 
                ...
                onCheckedChange={(checked) => handleConfigChange({ androidAuto: { enabled: checked } })}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="wireless-android-auto">Wireless Android Auto</Label>
              </div>
              <Switch 
                id="wireless-android-auto" 
                checked={config.androidAuto.wirelessMode}
                onCheckedChange={(checked) => handleConfigChange({ androidAuto: { wirelessMode: checked } })}
              />
            </div>
          ...
          <TabsContent value="about" className="space-y-4 py-4">
            <div className="flex flex-col items-center justify-center py-4">
              ...
              <div className="mt-6 text-sm text-center">
                <p className="mb-2">A modern car dashboard with CAN bus integration</p>
                <p className="mb-2">and Android Auto support</p>
                <p className="text-xs text-muted-foreground">© 2023 OpenCar Project</p>
              </div>
            </div>
            ...
            <div className="bg-muted/50 p-3 rounded-md flex items-center gap-2">
              ...
              <p className="text-xs">
                ...
                Always keep your attention on the road while driving.
              </p>
            </div>
          </TabsContent>
        </Tabs>
