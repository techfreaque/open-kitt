    ...
    <Card className={cn("h-full", className)}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          >
            <Snowflake className={cn("h-4 w-4", acEnabled ? "text-white" : "text-muted-foreground")} />
          ...
          >
            <Flame className={cn("h-4 w-4", heatEnabled ? "text-white" : "text-muted-foreground")} />
          ...
          >
            <RotateCw className={cn("h-4 w-4", autoMode ? "text-white" : "text-muted-foreground")} />
          ...
          >
            <Wind className={cn("h-4 w-4", recirculation ? "text-white" : "text-muted-foreground")} />
          ...
          >
            <Droplets className={cn("h-4 w-4", defrost ? "text-white" : "text-muted-foreground")} />
